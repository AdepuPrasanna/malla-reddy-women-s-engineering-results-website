  ...
  return (
    <div className="mx-auto max-w-5xl">
      <div className="text-center">
        ...
        <div className="mx-auto mt-5 inline-flex rounded-full border border-[rgb(var(--border)/0.12)] bg-[rgb(var(--surface-card)/0.6)] px-5 py-2 text-sm text-[rgb(var(--text-muted))]">
      ...
      <div className="mt-12 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        {HOME_CARDS.map((card) => (
          <button key={card.pageId} type="button" onClick={() => navigateTo(card.pageId)} className="home-card group text-left">
